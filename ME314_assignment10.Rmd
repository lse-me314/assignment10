...
speechDfm <- dfm(speechCorpus, remove = c(stopwords(source = "smart"),stopwords("english"), "will", "hon", "right","people","government","can","friend","house","gentleman","said", "interruption", "prime", "minister", "secretary", "state"), stem = F)

## Trim some rarely occuring words
speechDfm <- dfm_trim(speechDfm, min_termfreq = 15, minDoc = .0015 * ndoc(speechDfm))
